...
load("umap-by-cluster-flox-W2-clust-2-5.Robj")
...
save(flox.clust.active.ident, file = "cluster-per-cell-flox-W2-clust-2-5.Robj")
...
save(clust.umap, file = "umap-by-cluster-flox-W2-clust-2-5.Robj")
...
ggsave(plot = cluster.umap, filename = "umap-by-cluster-flox-W2-clust-2-5.png", device = "png", width = 6.5, height = 4.5, units = "in")
...
save(marker.genes, file = "marker-genes-flox-W2-clust-2-5.Robj")

write.csv(x = marker.genes, file = "marker-genes-flox-W2-clust-2-5.csv")
...
ggsave(plot = heatmap, filename = "heatmap-marker-genes-flox-W2-clust-2-5.png", device = "png", units = "in", width = 6.5, height = 9)
