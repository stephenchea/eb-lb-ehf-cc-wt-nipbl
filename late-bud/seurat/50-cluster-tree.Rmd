...
```{bash}
scp -r schea2@hpc3.rcic.uci.edu:/dfs6/pub/schea2/20210505-seurat/fin-integr-clust-6/fin-M*-cluster-iters /Volumes/Bud_SSD/20210505-seurat/fin-integr-clust-6
```
...
for (i in 2:max.res) {
  file.name <- paste0("/Volumes/Bud_SSD/20210505-seurat/fin-integr-clust-6/fin-", ident.clust[e], "-cluster-iters/cluster-per-cell-fin-", ident.clust[e], "-clust-", i, ".Robj")
  load(file.name)
  cluster.cell.list[[i-1]] <- as.numeric(fin.clust.active.ident)
}
...
title.plot <- paste0(ident.clust[e], ", Nipbl FIN/+")
...
filename.png <- paste0("/Volumes/Bud_SSD/20210505-seurat/fin-integr-clust-6/summary-shannon-fin-", ident.clust[e], ".png")
...
filename.png <- paste0("/Volumes/Bud_SSD/20210505-seurat/fin-integr-clust-6/cluster-tree-fin-", ident.clust[e], ".png")
