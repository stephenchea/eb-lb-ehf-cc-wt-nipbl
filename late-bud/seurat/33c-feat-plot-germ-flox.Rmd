...
```{r}
dir.create("/Volumes/Bud_SSD/20210505-seurat/flox-integr-clust-5/feat-plot-top-diff-genes-by-germ-layer")
...
filename.png <- paste0("/Volumes/Bud_SSD/20210505-seurat/flox-integr-clust-5/feat-plot-top-diff-genes-by-germ-layer/", target.clusters[i], "-", string.loop.count, "-", target.genes[i], "-feat-plot-flox-whole.png")
