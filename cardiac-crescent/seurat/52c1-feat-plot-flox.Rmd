...
Load FIN cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/fin-1.3-neighbors.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/fin-1.3-res-0.108/diff-genes-fin-1.3-res-0.108.Robj")
head(diff.genes)
```
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/fin-1.3-res-0.108/feat-plot-fin-1.3-res-0.108")
```
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/fin-1.3-res-0.108/feat-plot-fin-1.3-res-0.108/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-1.3-res-0.108.png")
ggsave(plot = feat.plot, filename = filename.png, device = "png", unit = "in", width = 3.5, height = 1.35)
