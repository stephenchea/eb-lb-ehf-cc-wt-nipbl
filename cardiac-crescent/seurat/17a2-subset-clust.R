...
setwd("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0630")
load("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0630/cluster-per-cell-flox-integr-res-0.0630.Robj")
...
filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0630/umap-by-stage-flox-", i, ".png")
...
filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0630/umap-facet-stage-flox-", i, ".png")
...
filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0630/umap-by-embryo-late-bud-flox-", i, ".png")
...
filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0630/umap-facet-embryo-late-bud-flox-", i, ".png")
...
filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0630/umap-by-embryo-cardiac-crescent-flox-", i, ".png")
#ggsave(plot = embryo.umap, filename = filename.robj, device = "png", width = 3.5, height = 2.25)
...
filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0630/umap-facet-embryo-cardiac-crescent-flox-", i, ".png")
#ggsave(plot = embryo.umap, filename = filename.robj, device = "png", width = 6.5, height = 3.6)
...
direct.path <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0630/", direct.name)
setwd(direct.path)
