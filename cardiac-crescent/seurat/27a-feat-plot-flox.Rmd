...
Load Flox cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/flox-3.1-neighbors.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/flox-3.1-res-0.0387/diff-genes-flox-3.1-res-0.0387.Robj")
head(diff.genes)
```
...
expr.umap <- as.data.frame(t(as.data.frame(flox.subclust@assays$SCT_3_1@data[top.genes,])))
...
dir.create("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/flox-3.1-res-0.0387/feat-plot-flox-3.1-res-0.0387")
```
...
for (i in colnames(expr.umap)[c(1:62, 64, 66:77, 79:81, 83:84, 86:89, 91:156)]) {
...
feat.plot <- ggplot(data = sample(expr.umap), mapping = aes(x = UMAP_1, y = UMAP_2)) +
    ...
    labs(title = str_replace(i, pattern = "_", replacement = "-"), subtitle = "Cluster 3.1, Nipbl Flox/+", x = "UMAP 1", y = "UMAP 2", color = "Norm\nUMI") +
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/flox-3.1-res-0.0387/feat-plot-flox-3.1-res-0.0387/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-flox-3.1-res-0.0387.png")
