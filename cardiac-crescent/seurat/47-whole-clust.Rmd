...
umap.whole[as.vector(rownames(umap.2 %>% filter(cluster.cluster == "2.4"))), "cluster.whole"] <- "2.4"
...
umap.whole$cluster.whole <- factor(umap.whole$cluster.whole, levels = c("1.1", "1.2", "1.3", "1.4", "2.1", "2.2", "2.3", "2.4", "3.1", "3.2", "4"))
...
labs(title = "Whole Embryo, Nipbl FIN/+", x = "UMAP 1", y = "UMAP 2", color = "Cluster") +
...
```{r}
save(umap.whole, file = "/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/umap-by-cluster-fin-integr-res-0.0151-11.Robj")
```

```{r}
ggsave(plot = cluster.umap, filename = "/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/umap-by-cluster-fin-integr-res-0.0151-11.png", device = "png", width = 3.5, height = 2.25, units = "in")
```

Upload files onto hpc3.
```{bash}
scp /Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/umap-by-cluster-fin-integr-res-0.0151-11.png schea2@hpc3.rcic.uci.edu:/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-res-0.0151

scp /Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/umap-by-cluster-fin-integr-res-0.0151-11.Robj schea2@hpc3.rcic.uci.edu:/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-res-0.0151
```