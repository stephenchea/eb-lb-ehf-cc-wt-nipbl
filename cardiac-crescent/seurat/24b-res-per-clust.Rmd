...
for (i in seq(from = 0, to = max.res, by = 0.001)) {
  file.name <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-2-res-0.056/flox-", n, "-cluster-iters/cluster-per-cell-flox-", n, "-res-", sprintf(fmt = "%.3f", i), ".Robj")
  load(file.name)
