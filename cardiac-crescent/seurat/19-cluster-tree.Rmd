...
```{bash}
scp -r schea2@hpc3.rcic.uci.edu:/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0120/flox-W*-cluster-iters /Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120
```
...
```{r}
ident.clust <- c("3", "2", "1")
optim.clust <- list("3" = c("0.004", "0.025", "0.052", "0.088", "0.099", "0.114", "0.206", "0.300", "0.364", "0.351"),
                    "2" = c("0.013", "0.027", "0.056", "0.081", "0.135", "0.145", "0.163", "0.199", "0.274", "0.357"),
                    "1" = c("0.015", "0.016", "0.030", "0.051", "0.074", "0.097", "0.112", "0.116", "0.139", "0.244"))
```
...
for (i in optim.clust[[e]]) {
  file.name <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-", e, "-cluster-iters/cluster-per-cell-flox-", e, "-res-", i, ".Robj")
  load(file.name)
  cluster.cell.list[[i]] <- as.numeric(cluster.cluster)
}
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/summary-shannon-flox-", e, ".png")
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/cluster-tree-flox-", e, ".png")
