...
Load FIN cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-1-projected-flox-1-res-0.074/fin-1.2-projected-flox-1.2-res-0.104/fin-1.2-projected-flox-1.2-res-0.104.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-1-projected-flox-1-res-0.074/fin-1.2-projected-flox-1.2-res-0.104/projected-diff-genes-fin-1.2-projected-flox-1.2-res-0.104.Robj")
head(diff.genes)
```
...
expr.umap <- as.data.frame(t(as.data.frame(fin.subclust@assays$SCT_1_2@data[top.genes,])))
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-1-projected-flox-1-res-0.074/fin-1.2-projected-flox-1.2-res-0.104/feat-plot-fin-1.2-projected-flox-1.2-res-0.104")
```
...
feat.plot <- ggplot(data = sample(expr.umap), mapping = aes(x = refUMAP_1, y = refUMAP_2)) +
    ...
    labs(title = str_replace(i, pattern = "_", replacement = "-"), subtitle = "Cluster 1.2, Nipbl FIN/+", x = "UMAP 1", y = "UMAP 2", color = "Norm\nUMI") +
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-1-projected-flox-1-res-0.074/fin-1.2-projected-flox-1.2-res-0.104/feat-plot-fin-1.2-projected-flox-1.2-res-0.104/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-1.2-projected-flox-1.2-res-0.104.png")
