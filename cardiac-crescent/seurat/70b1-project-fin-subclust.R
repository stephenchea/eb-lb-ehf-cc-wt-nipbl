...
res <- c("0.077", "0.150", "0.232")
names(res) <- c("2.3", "2.2", "2.1")

for (i in c("2.3", "2.2", "2.1")) {

    print("loading flox cells")
    filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0120/flox-2-res-0.056/flox-", i, "-neighbors.Robj")
    load(file = filename.robj)

    print("loading flox pc's")
    filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0120/flox-2-res-0.056/sig-pc-flox-", i, ".Robj")
    load(file = filename.robj)

    print("loading flox cluster identities")
    filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0120/flox-2-res-0.056/flox-", i, "-res-", res[i], "/cluster-per-cell-flox-", i, "-res-", res[i], ".Robj")
    load(file = filename.robj)
...
setwd("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-2-projected-flox-2-res-0.056")
load("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-2-projected-flox-2-res-0.056/fin-2-projected-flox-2-res-0.056.Robj")
...
dir.name <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-2-projected-flox-2-res-0.056/fin-", i, "-projected-flox-", i, "-res-", res[i])
dir.create(dir.name)
