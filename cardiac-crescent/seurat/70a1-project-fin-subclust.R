...
for (i in c("3.1")) {
    ...
    filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/flox-", i, "-neighbors.Robj")
    load(file = filename.robj)

    print("loading flox pc's")
    filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/sig-pc-flox-", i, ".Robj")
    load(file = filename.robj)

    print("loading flox cluster identities")
    filename.robj <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/flox-", i, "-res-", res[i], "/cluster-per-cell-flox-", i, "-res-", res[i], ".Robj")
    load(file = filename.robj)
...
setwd("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-3-projected-flox-3-res-0.025")
load("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-3-projected-flox-3-res-0.025/fin-3-projected-flox-3-res-0.025.Robj")

DefaultAssay(fin.clust) <- "RNA"
fin.clust[["SCT_3"]] <- NULL
fin.clust[["INT_3"]] <- NULL
...
dir.name <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-3-projected-flox-3-res-0.025/fin-", i, "-projected-flox-", i, "-res-", res[i])
dir.create(dir.name)
