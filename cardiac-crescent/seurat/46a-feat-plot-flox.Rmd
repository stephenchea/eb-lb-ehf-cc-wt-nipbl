...
Load FIN cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-3-neighbors.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/diff-genes-fin-3-res-0.015.Robj")
head(diff.genes)
```
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/feat-plot-fin-3-res-0.015")
```
...
for (i in colnames(expr.umap)[c(1:115, 117:148, 150:158)]) {
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/feat-plot-fin-3-res-0.015/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-3-res-0.015.png")
