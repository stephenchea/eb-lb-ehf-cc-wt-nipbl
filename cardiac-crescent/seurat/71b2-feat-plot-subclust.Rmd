...
Load FIN cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-2-projected-flox-2-res-0.056/fin-2.2-projected-flox-2.2-res-0.150/fin-2.2-projected-flox-2.2-res-0.150.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-2-projected-flox-2-res-0.056/fin-2.2-projected-flox-2.2-res-0.150/projected-diff-genes-fin-2.2-projected-flox-2.2-res-0.150.Robj")
head(diff.genes)
```
...
expr.umap <- as.data.frame(t(as.data.frame(fin.subclust@assays$SCT_2_2@data[top.genes,])))
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-2-projected-flox-2-res-0.056/fin-2.2-projected-flox-2.2-res-0.150/feat-plot-fin-2.2-projected-flox-2.2-res-0.150")
```
...
for (i in colnames(expr.umap)[c(1:92, 94:156)]) {
...
feat.plot <- ggplot(data = sample(expr.umap), mapping = aes(x = refUMAP_1, y = refUMAP_2)) +
    ...
    labs(title = str_replace(i, pattern = "_", replacement = "-"), subtitle = "Cluster 2.2, Nipbl FIN/+", x = "UMAP 1", y = "UMAP 2", color = "Norm\nUMI") +
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-2-projected-flox-2-res-0.056/fin-2.2-projected-flox-2.2-res-0.150/feat-plot-fin-2.2-projected-flox-2.2-res-0.150/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-2.2-projected-flox-2.2-res-0.150.png")
