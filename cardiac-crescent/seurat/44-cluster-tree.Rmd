...
```{r}
ident.clust <- c("3", "2", "1")
optim.clust <- list("3" = c("0.006", "0.015", "0.050", "0.070", "0.092", "0.104", "0.134", "0.179", "0.244", "0.337"),
                    "2" = c("0.016", "0.025", "0.042", "0.067", "0.091", "0.110", "0.180", "0.219", "0.243", "0.379"),
                    "1" = c("0.012", "0.021", "0.028", "0.037", "0.078", "0.109", "0.116", "0.102", "0.184", "0.205"))
```
...
for (i in optim.clust[[e]]) {
  file.name <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-", e, "-cluster-iters/cluster-per-cell-fin-", e, "-res-", i, ".Robj")
  load(file.name)
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/summary-shannon-fin-", e, ".png")
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/cluster-tree-fin-", e, ".png")
