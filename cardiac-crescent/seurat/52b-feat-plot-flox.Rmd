...
Load FIN cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.067/fin-2.4-neighbors.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.067/fin-2.4-res-0.212/diff-genes-fin-2.4-res-0.212.Robj")
head(diff.genes)
```
...
expr.umap <- as.data.frame(t(as.data.frame(fin.subclust@assays$SCT_2_4@data[top.genes,])))
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.067/fin-2.4-res-0.212/feat-plot-fin-2.4-res-0.212")
```
...
feat.plot <- ggplot(data = sample(expr.umap), mapping = aes(x = UMAP_1, y = UMAP_2)) +
    ...
    labs(title = str_replace(i, pattern = "_", replacement = "-"), subtitle = "Cluster 2.4, Nipbl FIN/+", x = "UMAP 1", y = "UMAP 2", color = "Norm\nUMI") +
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.067/fin-2.4-res-0.212/feat-plot-fin-2.4-res-0.212/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-2.4-res-0.212.png")
