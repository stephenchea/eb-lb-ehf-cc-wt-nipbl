...
optim.clust <- list("1.3" = c("0.056",  "0.104"),
                    "1.2" = c("0.039", "0.070", "0.104", "0.173", "0.269"),
                    "1.1" = c("0.052", "0.091", "0.177", "0.181", "0.245", "0.284"))
...
path.direct <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/flox-integr-res-0.0120/flox-1-res-0.074/", name.direct)
setwd(path.direct)
