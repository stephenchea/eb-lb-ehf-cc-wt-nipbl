...
```{r}
ident.clust <- c("3.1")
optim.clust <- list("3.1" = c("0.0054", "0.0144", "0.0387", "0.0704", "0.0806", "0.1459", "0.1571", "0.1583", "0.2940", "0.3828"))
```
...
for (i in optim.clust[[e]]) {
  file.name <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/flox-", e, "-cluster-iters/cluster-per-cell-flox-", e, "-res-", i, ".Robj")
  load(file.name)
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/summary-shannon-flox-", e, ".png")
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-3-res-0.025/cluster-tree-flox-", e, ".png")
