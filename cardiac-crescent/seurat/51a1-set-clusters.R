...
ident.clust <- c("3.1")
optim.clust <- list("3.1" = c("0.027", "0.049", "0.088"))
...
path.direct <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/", name.direct)
setwd(path.direct)
