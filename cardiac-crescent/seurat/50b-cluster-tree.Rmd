...
optim.clust <- list("2.3" = c("0.032", "0.062", "0.092", "0.177", "0.306", "0.374", "0.540", "0.696", "0.776", "0.839"),
                    "2.2" = c("0.067", "0.097", "0.107", "0.181", "0.291", "0.347", "0.437", "0.555", "0.593", "0.631"),
                    "2.1" = c("0.040", "0.067", "0.115", "0.159", "0.183", "0.211", "0.381", "0.460", "0.525", "0.675"))
```
...
for (i in optim.clust[[e]]) {
  file.name <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.042/fin-", e, "-cluster-iters/cluster-per-cell-fin-", e, "-res-", i, ".Robj")
  load(file.name)
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.042/summary-shannon-fin-", e, ".png")
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.042/cluster-tree-fin-", e, ".png")
