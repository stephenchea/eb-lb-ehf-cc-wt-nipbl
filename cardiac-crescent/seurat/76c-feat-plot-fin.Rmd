...
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-MES-projected-flox-MES-17/cluster-per-cell-fin-MES-17.Robj")
```

Load Flox cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-MES-projected-flox-MES-17/fin-MES-projected-flox-MES-17.Robj")
```
...
Load DEGs.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-MES-projected-flox-MES-17/projected-diff-genes-fin-MES-projected-flox-MES-17.Robj")
```
...
expr.umap <- as.data.frame(t(as.data.frame(fin.germ@assays$SCT_MES@data[top.genes,])))
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-MES-projected-flox-MES-17/feat-plot-fin-MES-projected-flox-MES-17")
```
...
feat.plot <- ggplot(data = sample(expr.umap), mapping = aes(x = refUMAP_1, y = refUMAP_2)) +
    ...
    labs(title = str_replace(i, pattern = "_", replacement = "-"), subtitle = "Mesoderm, Nipbl FIN/+", x = "UMAP 1", y = "UMAP 2", color = "Norm\nUMI") +
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-MES-projected-flox-MES-17/feat-plot-fin-MES-projected-flox-MES-17/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-MES-projected-flox-MES-17.png")
