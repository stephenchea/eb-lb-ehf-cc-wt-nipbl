...
Load FIN cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-neighbors.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.042/diff-genes-fin-2-res-0.042.Robj")
head(diff.genes)
```
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.042/feat-plot-fin-2-res-0.042")
```
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.042/feat-plot-fin-2-res-0.042/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-2-res-0.042.png")
