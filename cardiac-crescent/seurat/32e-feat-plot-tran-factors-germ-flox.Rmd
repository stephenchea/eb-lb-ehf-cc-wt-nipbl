...
```{r}
load("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/umap-by-germ-layer-flox-integr-res-0.0120-26.Robj")
```
...
Load diff-genes.
```{r}
diff.genes <- read.csv("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/diff-genes-annotated-between-germ-layers-CC-flox-integr-res-0.0120-26.csv")
head(diff.genes)
```
...
```{r}
dir.create("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/feat-plot-top-diff-genes-tran-factors-by-germ-layer")
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/feat-plot-top-diff-genes-tran-factors-by-germ-layer/", target.clusters[i], "-", string.loop.count, "-", target.genes[i], "-feat-plot-flox-whole.png")
