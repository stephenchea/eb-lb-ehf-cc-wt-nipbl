...
for (i in seq(from = 0, to = max.res, by = 0.001)) {
  file.name <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/fin-", n, "-cluster-iters/cluster-per-cell-fin-", n, "-res-", sprintf(fmt = "%.3f", i), ".Robj")
  load(file.name)
