...
```{r}
dir.create("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/feat-plot-top-diff-genes-by-germ-layer")
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/feat-plot-top-diff-genes-by-germ-layer/", target.clusters[i], "-", string.loop.count, "-", target.genes[i], "-feat-plot-flox-whole.png")
