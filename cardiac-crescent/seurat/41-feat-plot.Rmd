...
Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/diff-genes-fin-integr-res-0.0151.Robj")
head(diff.genes)
```
...
expr.umap <- cbind(expr.umap, fin.integr@reductions$umap@cell.embeddings)
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/feat-plot-diff-genes-fin-integr-res-0.0151")
```
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/feat-plot-diff-genes-fin-integr-res-0.0151/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-diff-genes-fin-integr-res-0.0151.png")
