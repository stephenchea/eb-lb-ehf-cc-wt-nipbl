...
optim.clust <- list("1.3" = c("0.025", "0.056", "0.104", "0.125", "0.187", "0.300", "0.519", "0.484", "0.620", "0.641"),
                    "1.2" = c("0.024", "0.039", "0.070", "0.104", "0.173", "0.269", "0.357", "0.404", "0.421", "0.454"),
                    "1.1" = c("0.011", "0.052", "0.091", "0.177", "0.181", "0.245", "0.284", "0.511", "0.541", "0.668"))
```
...
for (i in optim.clust[[e]]) {
  file.name <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-1-res-0.074/flox-", e, "-cluster-iters/cluster-per-cell-flox-", e, "-res-", i, ".Robj")
  load(file.name)
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-1-res-0.074/summary-shannon-flox-", e, ".png")
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-1-res-0.074/cluster-tree-flox-", e, ".png")
