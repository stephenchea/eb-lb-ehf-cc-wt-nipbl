...
Load FIN cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/fin-3.1-neighbors.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/fin-3.1-res-0.027/diff-genes-fin-3.1-res-0.027.Robj")
head(diff.genes)
```
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/fin-3.1-res-0.027/feat-plot-fin-3.1-res-0.027")
```
...
for (i in colnames(expr.umap)[c(1:84, 86, 90:97, 99:128, 130:149, 151:155, 157:158)]) {
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/fin-3.1-res-0.027/feat-plot-fin-3.1-res-0.027/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-3.1-res-0.027.png")
