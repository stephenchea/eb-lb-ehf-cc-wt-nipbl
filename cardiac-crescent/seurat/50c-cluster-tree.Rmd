...
optim.clust <- list("1.3" = c("0.026", "0.071", "0.108", "0.185", "0.205", "0.244", "0.274", "0.329", "0.589", "0.782"),
                    "1.2" = c("0.028", "0.058", "0.090", "0.137", "0.236", "0.286", "0.410", "0.589", "0.690", "0.757"),
                    "1.1" = c("0.026", "0.038", "0.073", "0.103", "0.133", "0.142", "0.161", "0.309", "0.630", "0.739"))
```
...
for (i in optim.clust[[e]]) {
  file.name <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/fin-", e, "-cluster-iters/cluster-per-cell-fin-", e, "-res-", i, ".Robj")
  load(file.name)
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/summary-shannon-fin-", e, ".png")
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/cluster-tree-fin-", e, ".png")
