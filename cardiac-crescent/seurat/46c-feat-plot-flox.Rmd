...
Load FIN cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-neighbors.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/diff-genes-fin-1-res-0.037.Robj")
head(diff.genes)
```
...
expr.umap <- cbind(expr.umap, fin.clust@reductions$umap@cell.embeddings)
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/feat-plot-fin-1-res-0.037")
```
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/feat-plot-fin-1-res-0.037/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-1-res-0.037.png")
