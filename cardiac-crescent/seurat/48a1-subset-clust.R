...
for (i in c("3.1")) {
    ...
    load("fin-3-neighbors.Robj")
    
    print("loading cluster identitites")
    setwd("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015")
    load("cluster-per-cell-fin-3-res-0.015.Robj")
    ...
    direct.path <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-res-0.0151/fin-3-res-0.015/", direct.name)
    setwd(direct.path)
