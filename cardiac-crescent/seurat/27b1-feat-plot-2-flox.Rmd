...
Load Flox cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-2-res-0.081/flox-2.4-neighbors.Robj")
```

Load markers.
```{r}
load("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-2-res-0.081/flox-2.4-res-0.082/diff-genes-flox-2.4-res-0.082.Robj")
head(diff.genes)
```
...
expr.umap <- as.data.frame(t(as.data.frame(flox.subclust@assays$SCT_2_4@data[top.genes,])))
...
dir.create("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-2-res-0.081/flox-2.4-res-0.082/feat-plot-flox-2.4-res-0.082")
```
...
for (i in colnames(expr.umap)[c(1:145, 147:156)]) {
...
feat.plot <- ggplot(data = sample(expr.umap), mapping = aes(x = UMAP_1, y = UMAP_2)) +
    ...
    labs(title = str_replace(i, pattern = "_", replacement = "-"), subtitle = "Cluster 2.4, Nipbl Flox/+", x = "UMAP 1", y = "UMAP 2", color = "Norm\nUMI") +
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/flox-integr-res-0.0120/flox-2-res-0.081/flox-2.4-res-0.082/feat-plot-flox-2.4-res-0.082/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-flox-2.4-res-0.082.png")
