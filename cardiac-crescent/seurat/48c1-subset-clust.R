...
for (i in c("1.3", "1.2", "1.1")) {
    ...
    load("cluster-per-cell-fin-1-res-0.037.Robj")
    ...
    direct.path <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-res-0.0151/fin-1-res-0.037/", direct.name)
    setwd(direct.path)
