...
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-ECT-projected-flox-ECT-9/cluster-per-cell-fin-ECT-9.Robj")
```

Load Flox cells.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-ECT-projected-flox-ECT-9/fin-ECT-projected-flox-ECT-9.Robj")
```
...
Load DEGs.
```{r}
load("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-ECT-projected-flox-ECT-9/projected-diff-genes-fin-ECT-projected-flox-ECT-9.Robj")
```
...
expr.umap <- as.data.frame(t(as.data.frame(fin.germ@assays$SCT_ECT@data[top.genes,])))
...
dir.create("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-ECT-projected-flox-ECT-9/feat-plot-fin-ECT-projected-flox-ECT-9")
```
...
feat.plot <- ggplot(data = sample(expr.umap), mapping = aes(x = refUMAP_1, y = refUMAP_2)) +
    ...
    labs(title = str_replace(i, pattern = "_", replacement = "-"), subtitle = "Ectoderm, Nipbl FIN/+", x = "UMAP 1", y = "UMAP 2", color = "Norm\nUMI") +
...
filename.png <- paste0("/Volumes/all_ssd/20220414-seurat/fin-integr-projected-flox-integr-res-0.0120/fin-ECT-projected-flox-ECT-9/feat-plot-fin-ECT-projected-flox-ECT-9/", top.clusters[i], "-", string.loop.count, "-", str_replace(i, pattern = "_", replacement = "-"), "-feat-plot-fin-ECT-projected-flox-ECT-9.png")
