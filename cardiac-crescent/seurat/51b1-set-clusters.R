...
optim.clust <- list("2.3" = c("0.062", "0.092", "0.177", "0.306", "0.374", "0.540"),
                    "2.2" = c("0.097", "0.107", "0.181", "0.291", "0.347"),
                    "2.1" = c("0.067", "0.115", "0.159", "0.183", "0.211", "0.381"))
...
path.direct <- paste0("/share/crsp/lab/alcalof/schea2/20220414-seurat/fin-integr-res-0.0151/fin-2-res-0.042/", name.direct)
setwd(path.direct)
